...
public class PesquisaPaciente extends javax.swing.JDialog {
    ...
    public PacienteDTO getP() {
        return p;
    }

    public void setP(PacienteDTO p) {
        this.p = p;
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        p.setNumBi(jTable1.getValueAt(indice,2).toString());
        p.setTelefone(jTable1.getValueAt(indice,3).toString());
        this.dispose();
    ...
    public void preencherTabela(){
        ...
        for(PacienteDTO pDTO : lista){
            modeloTabela.addRow(new Object[]{pDTO.getId_paciente(),pDTO.getNome(),pDTO.getNumBi(),pDTO.getTelefone()});
       }
    }
